...
function runTemperatureSweep(material: MaterialParams, config: SimulationConfig): Spectrum[] {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Plot
            ...
            layout={{
              width: 500,
              height: 400,
              title: "Bandgap vs Temperature", // <-- fixed type issue
              xaxis: { title: "T (K)" },
              yaxis: { title: "Eg (eV)" },
            }}
          />
          ...
          <Plot
            ...
            layout={{
              width: 500,
              height: 400,
              title: `PL Spectrum at T=${spectra[currentIndex].temperature.toFixed(1)} K`, // <-- fixed type issue
